...
const Sidebar = () => {
  return (
    <div className='w-full lg:w-[100px] h-auto lg:h-full flex lg:flex-col items-center justify-center lg:justify-end gap-5 py-[30px] md:py-[40px] lg:py-[50px] border-l-[1px] border-[#585d65] lg:fixed top-0 right-0 z-10'>
